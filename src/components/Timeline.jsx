...
export const Timeline = ({ data }) => {
  ...
  return (
    <div className="c-space mt-5" ref={containerRef}>
      <h2 className="text-heading">Achievements & other activities</h2>
            ...
            <div className="sticky z-5 flex flex-col items-center self-start max-w-xs md:flex-row top-40 lg:max-w-sm md:w-full">
              ...
              {item.date ? (
                <div className="flex-col hidden gap-2 text-xl font-bold md:flex md:pl-20 md:text-4xl text-neutral-300">
                  ...
                  {item.job && <h3 className="text-3xl text-neutral-500">{item.job}</h3>}
                </div>
              ) : (
                <div className="flex-col hidden gap-2 text-xl font-bold md:flex md:pl-20 md:text-4xl text-neutral-300">
                  <h3 className="text-3xl text-neutral-400">{item.title}</h3>
            ...
            <div className="relative w-full pl-20 pr-4 md:pl-4">
              ...
              {item.contents ? (
                ...
                <p className="mb-3 font-normal text-neutral-400">
                  {item.description || "Achievement details"}
                </p>
              )}
            </div>
          </div>
